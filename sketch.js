// ==========================================
// Title: TAO_PROCESSING - ARCHIVE (10 MODES)
// Style: Ryoji Ikeda / Monotone / Data / Glitch
// Modes: 10 distinct generative algorithms
// ==========================================
...
function draw() {
  ...
  switch(currentMode) {
    ...
    case 3: runTriMesh(); break;    // 三角网 (第一周)
    case 4: runBlueprint(); break;  // 蓝图 (第二周)
    case 5: runSlitScan(); break;   // 狭缝扫描 (第二周)
    case 6: runGridRunner(); break; // 网格行者 (新)
    case 7: runRadial(); break;     // 雷达扩散 (新)
    case 8: runBinary(); break;     // 二进制雨 (新)
    case 9: runNoiseField(); break; // 噪点场 (新)
  }
...
// ============================================================
// MODE 04: TRIANGLE MESH (三角网 - 也就是 "The Data-Flow")
// ============================================================
...
class Constructor {
  ...
  pickVel() {
    let speed = 4;
    if(random(1)<0.5) this.vel = createVector(random(1)<0.5?speed:-speed, 0);
    else this.vel = createVector(0, random(1)<0.5?speed:-speed);
  }
  update() {
    this.prev = this.pos.copy();
    this.pos.add(this.vel);
